...
## Project Structure
    ...
    ├── hamroequipment_37584  # Django project configurations
...
1. Clone this repo and `cd hamroequipment_37584`
...
2. Clone this repo and `cd hamroequipment_37584`
